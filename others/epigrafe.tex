...
%\end{citacao}
    ...
    \vspace*{5cm}
		...
		``Observability is the capability to continuously generate and discover actionable insights based on signals from the system under observation, with the goal of influencing the system \cite{hausenblas_2023}''.

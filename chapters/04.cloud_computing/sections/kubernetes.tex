...
\input{chapters/04.cloud_computing/subsections/k8s/k8s-arch}
\input{chapters/04.cloud_computing/subsections/k8s/obs-layer}
\input{chapters/04.cloud_computing/subsections/k8s/k8s-patterns}
\input{chapters/04.cloud_computing/subsections/k8s/pillars-obs-k8s}
\input{chapters/04.cloud_computing/subsections/k8s/instrumentation_levels}
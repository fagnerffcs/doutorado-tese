...
\input{chapters/04.cloud_computing/subsections/k8s/01.k8s-arch}

\input{chapters/04.cloud_computing/subsections/k8s/02.obs-layer}

\input{chapters/04.cloud_computing/subsections/k8s/03.k8s-patterns}

\input{chapters/04.cloud_computing/subsections/k8s/04.pillars-obs-k8s}

\input{chapters/04.cloud_computing/subsections/k8s/05.aligment-tech-rqs}

\input{chapters/04.cloud_computing/subsections/k8s/06.instrumentation_levels}
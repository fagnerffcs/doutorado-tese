...
4. Demonstration & Deployment of the artifact in a controlled lab (Multipass). & Chapter 5 \\ \hline
5. Evaluation & Controlled experiment using Chaos Engineering. & Chapter \ref{chap:methodology} Section \ref{sec:evaluation} \\ \hline

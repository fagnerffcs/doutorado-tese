...
This programmatic approach ensures that the experiments described in chapter \ref{chap:obs-experiment} are reproducible and strictly defined, aligning with the scientific method adopted in this work.
...
\textbf{Secondary Research Question 4} \textit{How can the evolutionary stages of observability in cloud-native environments be classified, and what are the primary gaps in current open-source implementations?}
...
\textbf{S04} \textit{To \textbf{conduct} a Rapid Review of the state-of-the-art to identify current architectural gaps and propose an Observability Maturity Model (OMM) that categorizes the evolutionary stages of telemetry management.}
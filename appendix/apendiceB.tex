...
\lstinputlisting[language=bash, caption={Ansible playbook for the automated deployment of the Vanilla Scenario.}, label={lst:deploy-baseline}]{chapters/06.experiment/code/infra/ansible/deploy-vanilla.yml}
...
\lstinputlisting[language=bash, caption={Ansible playbook for the automated deployment of the PANOPTES Observability Scenario.}, label={lst:deploy-panoptes}]{chapters/06.experiment/code/infra/ansible/deploy-panoptes.yml}
...
\lstinputlisting[language=bash, caption={PANOPTES OpenTelemetry Collector configuration.}, label={lst:panoptes-collector}]{chapters/06.experiment/code/infra/k8s/panoptes-collector.yml}
...
\lstinputlisting[language=bash, caption={Astronomy Shop Service Monitor definition.}, label={lst:astronomy-service-monitor}]{chapters/06.experiment/code/infra/k8s/astronomy-service-monitor.yml}
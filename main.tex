...
\setlength{\emergencystretch}{3em} % aumenta o espaçamento entre as palavras ao invés de estourar a margem
...
\newglossarystyle{modsuper}{%
  ...
  % put the glossary in a longtable environment without affecting table counter:
 \renewenvironment{theglossary}%
  {%
    \let\c@table\c@LT@tables% Usa contador separado para longtable
    \begin{longtable}
...
\usepackage{etoolbox}
% Impede que longtable incremente o contador de tabelas em glossários
\AtBeginEnvironment{theglossary}{%
  \let\oldthetable\thetable%
  \renewcommand{\thetable}{}%
  \addtocounter{table}{-1}%
}
\AtEndEnvironment{theglossary}{%
...
\glsaddall
\printnoidxglossary[style=altlist, type=\acronymtype, title={\listadesiglasname}, nonumberlist]
\newpage

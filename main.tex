...
\AtBeginDocument{
    \hypersetup{
        pdfborder={0 0 0}, % Remove a borda/caixa explicitamente
        colorlinks=true,   % Ativa coloração do texto (para podermos pintar de preto)
        linkcolor=black,   % Preto
        citecolor=black,   % Preto
        urlcolor=black,    % Preto
        filecolor=black,   % Preto
        bookmarksdepth=4   % Mantém os bookmarks do PDF funcionando
    }
}

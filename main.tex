...
\hypersetup{
    hidelinks,   % Remove as caixas coloridas
    colorlinks=true, % Opcional: mantem o texto colorido se quiser (se tirar isso, fica tudo preto)
    linkcolor=black, % Força links internos para preto (sumário, figuras)
    citecolor=black, % Força citações para preto
    urlcolor=black   % Força URLs para preto
}
